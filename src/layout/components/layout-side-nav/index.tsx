    ...
    <>
      ...
      <aside className={cn(s.aside, { [s.expanded]: expanded, [s.open]: navOpen })}>
        <div className={s.logoContainer}>
          ...
          <Icon name="bityield" width="113" color="primary" className={s.logoLabel} />
        </div>
        <nav className={s.top}>
        <Tooltip title={displayTooltip && 'SMART Yield'} placement="right">
          ...
          <Tooltip title={displayTooltip && 'FUND Alpha'} placement="right">
            <NavLink to="/fund-alpha" className={s.button} activeClassName={s.active}>
